namespace ToyRobot
{
    public class InputManager
    {
        ...
        public bool PromptUserToUseFileManager()
        {
            ...
            return Console.ReadLine().ToUpper().Trim() == Constants.CONFIRM_COMMAND;
        }
        ...
        public void PrintInstructions()
        {
            ...
            Console.WriteLine($"The available facings for the Robot are {string.Join(" - ", Constants.DIRECTIONS_ARRAY)}\n");
